...
func encodeCreateSandboxResponse(response CreateSandboxRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *CreateSandboxInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
		span.SetStatus(codes.Error, http.StatusText(500))
...
func encodeFetchFlakeResponse(response FetchFlakeRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *FetchFlakeOK:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
	...
	case *FetchFlakeInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
		span.SetStatus(codes.Error, http.StatusText(500))
...
func encodeGetExecutionJobByIdResponse(response GetExecutionJobByIdRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *GetExecutionJobByIdForbidden:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(403)
		span.SetStatus(codes.Error, http.StatusText(403))
...
func encodeGetExecutionResultByIdResponse(response GetExecutionResultByIdRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *GetExecutionResultByIdForbidden:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(403)
		span.SetStatus(codes.Error, http.StatusText(403))
...
func encodeGetExecutionsForJobResponse(response GetExecutionsForJobRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *GetExecutionsForJobForbidden:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(403)
		span.SetStatus(codes.Error, http.StatusText(403))
...
func encodeGetLoginConfigResponse(response GetLoginConfigRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *LoginConfig:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
	...
	case *GetLoginConfigInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
		span.SetStatus(codes.Error, http.StatusText(500))
...
func encodeGetValkyrieTokenResponse(response GetValkyrieTokenRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *GetValkyrieTokenOK:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
	...
	case *GetValkyrieTokenForbidden:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(403)
		span.SetStatus(codes.Error, http.StatusText(403))
	...
	case *GetValkyrieTokenInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
		span.SetStatus(codes.Error, http.StatusText(500))
