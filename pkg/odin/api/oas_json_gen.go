...
var jsonFieldsNameOfExecutionRequest = [10]string{
	0: "environment",
	1: "code",
	2: "language",
	3: "max_retries",
...
func (s *Language) encodeFields(e *jx.Encoder) {
	...
	{
		e.FieldStart("defaultcode")
		e.Str(s.Defaultcode)
	}
	{
		e.FieldStart("monacolanguage")
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "defaultcode":
			...
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"defaultcode\"")
			}
		case "monacolanguage":
			requiredBitSet[0] |= 1 << 3
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"monacolanguage\"")
			}
		case "searchquery":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
