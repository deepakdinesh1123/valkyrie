...
func decodeGenerateUserTokenResponse(resp *http.Response) (res GenerateUserTokenRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GenerateUserTokenOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 400:
		...
		case ct == "application/json":
			...
			var response GenerateUserTokenBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/json":
			...
			var response GenerateUserTokenForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/json":
			...
			var response GenerateUserTokenInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeGetSystemPackagesResponse(resp *http.Response) (res *Package, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeGetTokenResponse(resp *http.Response) (res GetTokenRes, _ error) {
	...
	case 403:
		...
		case ct == "application/json":
			...
			var response GetTokenForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/json":
			...
			var response GetTokenInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeSearchPackagesResponse(resp *http.Response) (res SearchPackagesRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
