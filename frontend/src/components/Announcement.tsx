...
const Announcement: React.FC<AnnouncementProps> = ({ isOpen, onClose }) => {
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="bg-black p-6">
                <DialogHeader>
                    <DialogTitle className="text-white">Notice</DialogTitle>
                    <DialogDescription className="text-white">
                        Due to server constraints, our worker instances will be temporarily offline everyday from 10 PM to 8 AM IST (GMT + 5:30). We are actively working towards expanding our resources to keep services available 24/7. We appreciate your understanding and patience.
                    </DialogDescription>
                </DialogHeader>
